...
export default function Footer() {
  return (
    <footer className="bg-white text-[#282023] pt-14 pb-10 border-t border-slate-200/90 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-1/4 w-[600px] h-[300px] bg-[#8C5288]/[0.03] rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* ========================================================================= */}
        <div className="mb-14 p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-[#faf8fb] via-white to-[#f6fbf7] border border-slate-200/90 shadow-2xs flex flex-col lg:flex-row items-center justify-between gap-6">
          <div className="space-y-1.5 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-[#8C5288]/10 text-[#8C5288] text-[11px] font-bold uppercase tracking-wider">
              <Sparkles className="w-3 h-3 text-[#8C5288]" />
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 shrink-0">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#8C5288] hover:bg-[#763f72] text-white text-xs font-bold shadow-md shadow-[#8C5288]/20 hover:shadow-lg transition-all"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 py-12 border-b border-slate-100">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#faf8fb] border border-[#8C5288]/15 text-xs font-semibold text-[#282023]">
            ...
            <div className="flex items-center gap-2.5 pt-1">
              <a 
                ...
                rel="noreferrer"
                aria-label="Facebook"
                className="w-9 h-9 rounded-xl bg-slate-50 hover:bg-[#8C5288] text-slate-600 hover:text-white border border-slate-200/80 flex items-center justify-center transition-all duration-200 shadow-2xs hover:shadow-sm"
              >
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-sm font-medium text-slate-600">
              <li>
                <Link href="/products#industries" className="hover:text-[#8C5288] transition-colors">Supermarkets &amp; Retail</Link>
              </li>
              <li>
                <Link href="/products#industries" className="hover:text-[#8C5288] transition-colors">Restaurants &amp; QSRs</Link>
              </li>
              <li>
                <Link href="/products#industries" className="hover:text-[#8C5288] transition-colors">Hotels &amp; Resorts</Link>
              </li>
              <li>
                <Link href="/products#industries" className="hover:text-[#8C5288] transition-colors">Wholesale &amp; FMCG</Link>
              </li>
              <li>
                <Link href="/products#industries" className="hover:text-[#8C5288] transition-colors">Pharmacies &amp; Clinics</Link>
              </li>
              <li>
                <Link href="/products#industries" className="hover:text-[#8C5288] transition-colors">Manufacturing Units</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-sm font-medium text-slate-600">
              <li>
                <Link href="/" className="hover:text-[#8C5288] transition-colors">Home</Link>
              </li>
              <li>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-600">
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-[#8C5288] shrink-0 mt-0.5" />
                <span className="leading-relaxed">Coimbatore, Tamil Nadu, India</span>
              </div>
              
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-[#40C351] shrink-0" />
                <a href="tel:+911234567890" className="font-semibold hover:text-[#8C5288] transition-colors">+91 12345 67890</a>
              </div>
              
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-[#8C5288] shrink-0" />
                <a href="mailto:info@doonext.com" className="font-semibold hover:text-[#8C5288] transition-colors">info@doonext.com</a>
              </div>

              <div className="flex items-center gap-2">
                <Globe className="w-4 h-4 text-[#40C351] shrink-0" />
                <a href="https://www.doonext.com" target="_blank" rel="noreferrer" className="font-semibold hover:text-[#8C5288] transition-colors">www.doonext.com</a>
              </div>
            </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 font-medium">
            <Link href="/privacy-policy" className="hover:text-[#8C5288] transition-colors">Privacy Policy</Link>
            <span className="text-slate-300">•</span>
            <Link href="/terms-conditions" className="hover:text-[#8C5288] transition-colors">Terms &amp; Conditions</Link>
            <span className="text-slate-300">•</span>
